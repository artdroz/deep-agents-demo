 ...
 *
 * Note: the IDE workspace no longer uses this modal, but it remains available
 * for any future "preview file" UX.
 */
...
export function FileViewerModal({ file, onClose }: FileViewerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div
          style={{ padding: "var(--space-6) var(--space-6) var(--space-4) var(--space-6)" }}
