...
import { ChatHeaderTTSControl } from "@/components/ChatHeaderTTSControl";
import { CopilotChatWithTTS } from "@/components/CopilotChatWithTTS";
          ...
          <div className="h-full flex flex-col">
            ...
            <header style={{ padding: "var(--space-8)" }} className="border-b border-[var(--color-border-glass)]">
              <div className="flex items-start justify-between" style={{ gap: "var(--space-4)" }}>
                ...
                <ChatHeaderTTSControl enabled={autoReadEnabled} onToggle={setAutoReadEnabled} />
              </div>
            </header>
