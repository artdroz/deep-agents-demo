...
export default function Page() {
  ...
  // STT-managed input value. If the underlying chat input changes internally,
  // we fall back to this as the source of truth for what STT appends to.
  ...
  // Memoize the custom input to avoid re-creating it excessively.
  const inputToolbar = useMemo(() => {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <SpeechToTextButton value={chatInputValue} onChange={setChatInputValue} />
      </div>
    );
  }, [chatInputValue]);
